...
class LaravelLocalization
{
	...
	public static $cacheExpiration = 3600; // In seconds (e.g. 3600 for 1h)
	...
	public function __construct()
	{
		...
		self::$cacheExpiration = (int)config('settings.other.cache_expiration', self::$cacheExpiration);
	 ...
	 *
	 * @param null $locale 		Locale to set the App to (optional)
	 * @return null 			Returns locale (if route has any) or null (if route does not have a locale)
	 * @throws SupportedLocalesNotDefined
	 */
	 ...
	 *
	 * @param null $url 			URL to adapt. If not passed, the current url would be taken.
	 * @param null $locale 			Locale to adapt, false to remove locale
	 * @return false|string 		URL translated
	 * @throws SupportedLocalesNotDefined
	 * @throws UnsupportedLocaleException
	 */
	 ...
	 *
	 * @param null $locale 			Locale to adapt, false to remove locale
	 * @param null $url 			URL to adapt in the current language. If not passed, the current url would be taken.
	 * @param array $attributes 	Attributes to add to the route, if empty, the system would try to extract them from the url.
	 * @return false|\Illuminate\Contracts\Routing\UrlGenerator|null|string    URL translated, False if url does not exist
	 * @throws SupportedLocalesNotDefined
	 * @throws UnsupportedLocaleException
	 */
	public function getLocalizedURL($locale = null, $url = null, $attributes = [])
	{
		...
		if (empty($url)) {
			...
			// user edit routes like : account/companies/5440/edit
			if (isset($attributes['attrId'])) {
				if(!empty($attributes['attrId'])){
					$this->routeName = '';
				}
			}
	 ...
	 *
	 * @param null $url 			URL to clean, if false, current url would be taken
	 * @return false|string 		URL with no locale in path
	 * @throws SupportedLocalesNotDefined
	 * @throws UnsupportedLocaleException
	 */
	 ...
	 *
	 * @return mixed    Current locale name
	 * @throws SupportedLocalesNotDefined
	 */
	 ...
	 *
	 * @return mixed    Current locale native name
	 * @throws SupportedLocalesNotDefined
	 */
	 ...
	 *
	 * @return mixed    Current locale script
	 * @throws SupportedLocalesNotDefined
	 */
	 ...
	 *
	 * @return mixed    Current language's native reading
	 * @throws SupportedLocalesNotDefined
	 */
	 ...
	 *
	 * @return mixed|string    Current language
	 * @throws SupportedLocalesNotDefined
	 */
