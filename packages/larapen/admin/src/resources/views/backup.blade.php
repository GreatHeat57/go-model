    ...
    <script>
        jQuery(document).ready(function($) {
            ...
            $("[data-button-type=delete]").click(function(e) {
                ...
                if (confirm("{{ trans('admin::messages.backup_delete_confirm') }}") == true) {
                    $.ajax({
                        url: delete_url,
                        type: 'DELETE',
                        success: function(result) {
                            // Show an alert with the result
                            new PNotify({
                                title: "{{ trans('admin::messages.backup_delete_confirmation_title') }}",
                                text: "{{ trans('admin::messages.backup_delete_confirmation_message') }}",
                                type: "success"
                            });
