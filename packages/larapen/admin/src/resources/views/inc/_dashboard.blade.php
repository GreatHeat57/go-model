...
@section('after_styles')
    ...
    <link rel="stylesheet" href="{{ asset('vendor-admin/vendor-admin/adminlte/') }}/plugins/morris/0.5.1/morris.css">
@endsection

@section('after_scripts')
    <script src="//cdnjs.cloudflare.com/ajax/libs/raphael/2.1.0/raphael-min.js"></script>
    <script src="{{ asset('vendor-admin/vendor-admin/adminlte') }}/plugins/morris/morris.min.js"></script>
