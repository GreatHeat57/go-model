...
<head>
    ...
    <!-- Bootstrap 3.3.5 -->
    <link rel="stylesheet" href="{{ asset('vendor-admin/vendor-admin/adminlte/') }}/bootstrap/css/bootstrap.min.css">
    <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/font-awesome/4.4.0/css/font-awesome.min.css">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/ionicons/2.0.1/css/ionicons.min.css">

    <link rel="stylesheet" href="{{ asset('vendor-admin/vendor-admin/adminlte/') }}/dist/css/AdminLTE.min.css">
    <!-- AdminLTE Skins. Choose a skin from the css/skins folder instead of downloading all of them to reduce the load. -->
    <link rel="stylesheet" href="{{ asset('vendor-admin/vendor-admin/adminlte/') }}/dist/css/skins/_all-skins.min.css">

    <link rel="stylesheet" href="{{ asset('vendor-admin/vendor-admin/adminlte/') }}/plugins/pace/pace.min.css">
    <link rel="stylesheet" href="{{ asset('vendor-admin/vendor-admin/admin/pnotify/pnotify.custom.min.css') }}">

    <!-- Admin Global CSS -->
    <link rel="stylesheet" href="{{ asset('vendor-admin/vendor-admin/admin/style.css') . vTime() }}">
...
<body class="hold-transition {{ config('larapen.admin.skin') }} sidebar-mini">
    ...
    <script>window.jQuery || document.write('<script src="{{ asset('vendor-admin/vendor-admin/adminlte') }}/plugins/jQuery/jquery-2.2.0.min.js"><\/script>')</script>
    <!-- Bootstrap 3.3.5 -->
    <script src="{{ asset('vendor-admin/vendor-admin/adminlte') }}/bootstrap/js/bootstrap.min.js"></script>
    <script src="{{ asset('vendor-admin/vendor-admin/adminlte') }}/plugins/pace/pace.min.js"></script>
    <script src="{{ asset('vendor-admin/vendor-admin/adminlte') }}/plugins/slimScroll/jquery.slimscroll.min.js"></script>
    <script src="{{ asset('vendor-admin/vendor-admin/adminlte') }}/plugins/fastclick/fastclick.js"></script>
    <script src="{{ asset('vendor-admin/vendor-admin/adminlte') }}/dist/js/app.min.js"></script>
