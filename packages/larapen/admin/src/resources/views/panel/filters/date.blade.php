...
@push('crud_list_styles')
	<link href="{{ asset('vendor-admin/vendor-admin/adminlte/') }}/plugins/datepicker/datepicker3.css" rel="stylesheet" type="text/css" />
	<style>
		.input-group.date {
			width: 320px;
			max-width: 100%;
...
@push('crud_list_scripts')
	<!-- include select2 js-->
	<script type="text/javascript" src="{{ asset('vendor-admin/vendor-admin/adminlte/') }}/plugins/datepicker/bootstrap-datepicker.js"></script>
	<script>
