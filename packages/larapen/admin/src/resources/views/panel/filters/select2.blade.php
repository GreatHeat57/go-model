...
@push('crud_list_styles')
    <!-- include select2 css-->
    <link href="{{ asset('vendor-admin/vendor-admin/admin/select2/select2.css') }}" rel="stylesheet" type="text/css" />
    <link href="{{ asset('vendor-admin/vendor-admin/admin/select2/select2-bootstrap-dick.css') }}" rel="stylesheet" type="text/css" />
    <style>
...
@push('crud_list_scripts')
	<!-- include select2 js-->
    <script src="{{ asset('vendor-admin/vendor-admin/admin/select2/select2.js') }}"></script>
    <script>
