...
@if ($xPanel->checkIfFieldIsFirstOfItsType($field, $fields))
    ...
    <link rel="stylesheet" href="{{ asset('vendor-admin/vendor-admin/adminlte/') }}/plugins/datepicker/datepicker3.css">
    ...
    <script src="{{ asset('vendor-admin/vendor-admin/adminlte/') }}/plugins/datepicker/bootstrap-datepicker.js"></script>
    <script type="text/javascript" src="{{ asset('vendor-admin/vendor-admin/adminlte/') }}/plugins/daterangepicker/moment.min.js"></script>
    ...
    @if ($field_language !== 'en')
        <script charset="UTF-8" src="{{ asset('vendor-admin/vendor-admin/adminlte/plugins/datepicker/locales/bootstrap-datepicker.'.$field_language.'.js') }}"></script>
