...
@if ($xPanel->checkIfFieldIsFirstOfItsType($field, $fields))
    ...
    <!-- include select2 css-->
    <link href="{{ asset('vendor-admin/vendor-admin/adminlte/plugins/select2/select2.min.css') }}" rel="stylesheet" type="text/css" />
    ...
    <!-- include select2 js-->
    <script src="{{ asset('vendor-admin/vendor-admin/adminlte/plugins/select2/select2.min.js') }}"></script>
    <script>
