	...
	public function setup()
	{
		...
		*/
		...
		if (!empty($section)) {
			...
			if (in_array($section->method, ['getSearchForm'])) {
				...
				$backgroundImageField = [
					...
					'hint'     => __t('Choose a picture from your computer') . '<br>' .
						__t('You can set a background image by country in Admin panel International_Countries_Edit_Background_Image'),
				];
			...
			// getSponsoredPosts, getLatestPosts, getCategories & getFeaturedPostsCompanies
			if (in_array($section->method, ['getSponsoredPosts', 'getLatestPosts', 'getCategories', 'getFeaturedPostsCompanies'])) {
				$cacheExpirationField = [
					'name'              => 'cache_expiration',
					'label'             => __t("Cache Expiration Time for this section"),
					'fake'              => true,
