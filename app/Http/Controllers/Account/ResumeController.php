...
class ResumeController extends AccountBaseController
{
	...
	public function index()
	{
		...
		MetaTag::set('description', t('My Resumes List - :app_name', ['app_name' => config('settings.app.name')]));
	...
	public function create()
	{
		...
		MetaTag::set('description', t('Create a resume - :app_name', ['app_name' => config('settings.app.name')]));
	...
	public function edit($id)
	{
		...
		MetaTag::set('description', t('Edit the resume - :app_name', ['app_name' => config('settings.app.name')]));
