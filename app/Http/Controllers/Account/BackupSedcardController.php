...
class BackupSedcardController extends AccountBaseController {
	private $perPage = 10;
	...
	public function index() {
		...
		return view('account.sedcard.index')->with('sedcards', $sedcards);
	}
	...
	public function create() {
		...
		return view('account.sedcard.create');
	}
  ...
  line-height:1.2px;
	...
	<tr>
		<td style="padding-right: 15px;">
			<img src="' . $image_url[0] . '" style="padding-bottom:7px;max-height: 560px;width:450px;">
      <p ><b>' . $firstname . '</b>, ' . $size . ', ' . $city . ' </p>
		</td>
		<td style="padding-left: 15px;vertical-align: baseline;">
			<table>
				<tr >
					<td  style="padding-right: 7px; padding-bottom:7px;"><img style="width:220px;height:250px" src="' . $image_url[1] . '"></td>
					<td style="padding-left: 7px; padding-bottom:7px;"><img style="width:220px;height:250px" src="' . $image_url[2] . '"></td>
				</tr>
				<tr>
					<td style="padding-right: 7px; padding-top:6px;"><img style="width:220px;height:250px" src="' . $image_url[3] . '"></td>
					<td style="padding-left: 7px; padding-top:6px;"><img style="width:220px;height:250px" src="' . $image_url[4] . '"></td>
				</tr>
				<tr>
