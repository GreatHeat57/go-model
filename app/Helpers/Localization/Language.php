...
class Language
{
    ...
    public static $cacheExpiration = 3600; // in seconds
    ...
    public function fromUrl()
    {
        ...
        // read segment from url
        $segment = Request::segment(1);

        //get all supported language locale
        ...
        if(isset($segment) && app('laravellocalization')->checkLocaleInSupportedLocales($segment)){
            ...
            $lang = collect($locales[$segment]);
        }else{

            $langCode = $hrefLang = config('app.locale');
            if ($langCode != '') {
