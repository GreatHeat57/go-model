...
class ActiveScope implements Scope
{
    ...
    public function apply(Builder $builder, Model $model)
    {
		...
		// Load only Country action BlogCategoryController, BlogEntryController
		if (Str::contains(Route::currentRouteAction(), 'App\Http\Controllers\Admin\BlogCategoryController') || Str::contains(Route::currentRouteAction(), 'App\Http\Controllers\Admin\BlogEntryController')) {
			return $builder->where('active', 1);
		}
