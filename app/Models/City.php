...
class City extends BaseModel
{
    ...
    */
    ...
    public static function getCityNameByCode($code){
        $asciiname= City::withoutGlobalScopes([ActiveScope::class])->select('asciiname')->where('code', $code)->first();
    ...
    public static function getCityIdByName($name){
        ...
        $City= City::withoutGlobalScopes([ActiveScope::class])->select('id','longitude','latitude')->whereRaw('lower(name)', strtolower($name))->orwhereRaw('lower(asciiname)', strtolower($name))->first();
     ...
     public static function getWPCityIdByName($name){   
