...
class Payment extends BaseModel {
	 ...
	 * @var array
	 */
	protected $fillable = ['post_id', 'package_id', 'payment_method_id', 'transaction_id', 'active', 'transaction_status', 'transaction_expiry_date', 'transaction_listings', 'transaction_listing_expiry', 'transaction_listing_period', 'transaction_amount', 'packege_price', 'tax_price', 'additional_charges', 'gateway'];
