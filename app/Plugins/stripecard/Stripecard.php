...
class Stripecard extends Payment {
	/**
	 * Send Payment
	 *
	...
	public static function installed() {
		$paymentMethod = PaymentMethod::active()->where('name', 'LIKE', 'stripecard')->first();
	...
	public static function install() {
		...
		$data = [
			...
			'description' => 'Card Payment with Stripe',
			'has_ccbox' => 1,
			'lft' => 2,
			'rgt' => 2,
			'depth' => 1,
	...
	public static function uninstall() {
		$paymentMethod = PaymentMethod::where('name', 'LIKE', 'stripecard')->first();
		if (!empty($paymentMethod)) {
