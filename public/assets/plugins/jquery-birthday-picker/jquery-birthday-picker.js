$(function ($)
{
    ...
    generateBirthdayPicker = function ($parent, options) 
    {
        ...
        var $error_msg_div = "<div class='form-input-error-msg'><span class='fa fa-exclamation-circle'></span>This field is required!</div>";
        $('#'+parentId).append($day_input).append($month_input).append($year_input);
         ...
         // Add the option placeholders if specified
          if (options.placeholder) {
            $("<option class='not-option' value=''>Year</option>").appendTo($year);
            $("<option class='not-option' value=''>Month</option>").appendTo($month);
            $("<option class='not-option' value=''>Day</option>").appendTo($day);
          }
