		...
		create: function(el, options) {
			...
			if(this.o.filter == true || this.o.controls == true){
				...
				if(this.o.filter == true){
					...
					x += this.o.wall == true ? '<li><a title="All" href="#filter" data-group="dc-filter"  data-filter="*" class="selected link-all">all</a></li>' : '' ;
					var $f = $('.filter',el);
					$.each(opt.feeds, function(k,v){
						x += v.id != '' ? '<li class="active f-'+k+'"><a title="'+k.charAt(0).toUpperCase() + k.slice(1)+'" href="#filter" rel="'+k+'" data-group="dc-filter" data-filter=".dcsns-'+k+'"><span class="socicon socicon-'+k+'"></span></a></li>' : '' ;
					});
					x += '</ul>';
				}
