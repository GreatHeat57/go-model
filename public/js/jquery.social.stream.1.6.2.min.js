...
if(this.o.filter==true||this.o.controls==true){var x='<div class="dcsns-toolbar">';if(this.o.filter==true){var fclass=this.o.center==true?'option-set filter dc-center':'option-set filter';x+='<ul id="dcsns-filter" class="'+fclass+' '+this.o.style.layout+' '+this.o.style.colour+'">';x+=this.o.wall==true?'<li><a title="All" href="#filter" data-group="dc-filter"  data-filter="*" class="selected link-all">all</a></li>':'';var $f=$('.filter',el);$.each(opt.feeds,function(k,v){x+=v.id!=''?'<li class="active f-'+k+'"><a href="#filter" title="'+k.charAt(0).toUpperCase() + k.slice(1)+'" rel="'+k+'" data-group="dc-filter" data-filter=".dcsns-'+k+'"><span class="socicon socicon-'+k+'"></span></a></li>':'';});x+='</ul>';}
