		...
		<div class="container">
			<div class="row">
				...
				<div class="col-sm-9 page-content">
                    ...
                    <div class="inner-box">
						<h2 class="title-2"><i class="icon-graduation-cap"></i> {{ t('Add experiences in the model business') }} </h2>
									...
									<div class="panel-body">
                                        <form name="details" class="form-horizontal" role="form" method="POST" action="{{ lurl('account/profile/experience') }}" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group required <?php echo (isset($errors) and $errors->has('experience.title')) ? 'has-error' : ''; ?>">
                                                ...
                                                <div class="col-sm-8">
                                                    <input name="title" type="text" class="form-control" placeholder="{{ t('Title') }}" value="{{ old('name', '') }}" required>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">                                
                                                ...
                                                <div class="col-sm-9">
                                                	<input type="checkbox" name="up_to_date" value="date('Y/m/d')">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group required <?php echo (isset($errors) and $errors->has('experience.company')) ? 'has-error' : ''; ?>">
                                                ...
                                                <div class="col-sm-8">
                                                    <input name="company" type="text" class="form-control" placeholder="{{ t('Company') }}" value="{{ old('name', '') }}" required>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group required <?php echo (isset($errors) and $errors->has('experience.description')) ? 'has-error' : ''; ?>">
                                                ...
                                                <div class="col-sm-8">
                                                    <textarea id="experience_description" name="description" value="test"></textarea>
                                                </div>
                                            </div>
...
@section('after_scripts')
	...
	<script>
        ...
        function set_date_from(){
            ...
            $('[name="experience_from_birthDay"]').val(formatDate());
		}
		...
		function set_date_to(){
            ...
            $('[name="experience_to_birthDay"]').val(formatDate());
		}
