		...
		<div class="container">
			<div class="row">
				...
				<div class="col-sm-9 page-content">
                    ...
                    <div class="inner-box">
						<h2 class="title-2"><i class="icon-graduation-cap"></i> {{ t('Add education') }} </h2>
									...
									<div class="panel-body">
                                        <form name="details" class="form-horizontal" role="form" method="POST" action="{{ lurl('account/profile/education') }}" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group required <?php echo (isset($errors) and $errors->has('education.institute')) ? 'has-error' : ''; ?>">
                                                ...
                                                <div class="col-sm-8">
                                                    <input name="institute" type="text" class="form-control" placeholder="{{ t('Institute') }}" value="{{ old('name', '') }}" required>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group required <?php echo (isset($errors) and $errors->has('education.description')) ? 'has-error' : ''; ?>">
                                                ...
                                                <div class="col-sm-8">
                                                    <textarea id="education_description" name="description" value="test"></textarea>
                                                </div>
                                            </div>
...
@section('after_scripts')
	...
	<script>
        ...
        function set_date_from(){
            ...
            $('[name="education_from_birthDay"]').val(formatDate());
		}
		...
		function set_date_to(){
            ...
            $('[name="education_to_birthDay"]').val(formatDate());
		}
