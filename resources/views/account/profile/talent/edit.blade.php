		...
		<div class="container">
			<div class="row">
				...
				<div class="col-sm-9 page-content">
                    ...
                    <div class="inner-box">
						<h2 class="title-2"><i class="icon-eye"></i> {{ t('Edit talents') }} </h2>
									...
									<div class="panel-body">
										<form name="details" class="form-horizontal" role="form" method="POST" action="{{ lurl('account/profile/talent') }}" enctype="multipart/form-data">
											...
											<div class="form-group required <?php echo (isset($errors) and $errors->has('talents.title')) ? 'has-error' : ''; ?>">
												...
												<div class="col-sm-8">
													<input name="title" type="text" class="form-control" placeholder="{{ t('Heading of the ability') }}" value="{{ old('name', $talent['title']) }}" required>
												</div>
											</div>
											...
											<div class="form-group required <?php echo (isset($errors) and $errors->has('talents.proportion')) ? 'has-error' : ''; ?>">
												...
												<div class="col-sm-3">
													<input name="proportion" type="text" class="form-control" placeholder="{{ t('proportion of') }}" value="{{ old('name', $talent['proportion']) }}" required>
												</div>
											</div>
