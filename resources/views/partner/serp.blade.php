...
@section('search')
	@parent
	@include('partner.inc.form')
@endsection

@section('content')
	<div class="main-container">
		
		@include('partner.inc.breadcrumbs')
		@include('partner.inc.categories')
				...
				<div class="col-sm-12 page-content col-thin-left">
					<div class="category-list">
						<div class="tab-box clearfix">
							...
							<div class="col-lg-12 box-title no-border">
								<div class="inner">
									<h2>
										<!--small>{{ $count }} {{ t('Partner(s) Found') }}</small-->
									</h2>
								</div>
							</div>
						...
						<div class="listing-filter hidden-xs">
							...
							<div class="pull-right col-sm-2 col-xs-12 text-right text-center-xs listing-view-action">
								@if (!empty(\Illuminate\Support\Facades\Request::all()))
									...
									<a class="clear-all-button text-muted" href="{!! lurl('partner-list', $attr) !!}">{{ t('Clear all') }}</a>
								@endif
							</div>
					...
					@if (!auth()->check())
						<div class="post-promo text-center">
							...
							<a href="{{ lurl(trans('routes.register')) . '?type=3' }}" class="btn btn-border btn-post btn-add-listing">
