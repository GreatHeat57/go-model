@if (
		(\Illuminate\Support\Str::contains(\Route::currentRouteAction(), 'Auth\RegisterController')) or
		...
		(\Illuminate\Support\Str::contains(\Route::currentRouteAction(), 'Search\CompanyController') and config('settings.seo.no_index_companies') == true)
	)
