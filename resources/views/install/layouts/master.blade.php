...
<head>
	...
	<link rel="apple-touch-icon-precomposed" sizes="144x144" href="{{ url(config('app.cloud_url').'/assets/ico/apple-touch-icon-144-precomposed.png') }}">
	<link rel="apple-touch-icon-precomposed" sizes="114x114" href="{{ url(config('app.cloud_url').'/assets/ico/apple-touch-icon-114-precomposed.png') }}">
	<link rel="apple-touch-icon-precomposed" sizes="72x72" href="{{ url(config('app.cloud_url').'/assets/ico/apple-touch-icon-72-precomposed.png') }}">
	<link rel="apple-touch-icon-precomposed" href="{{ url(config('app.cloud_url').'/assets/ico/apple-touch-icon-57-precomposed.png') }}">
	<link rel="shortcut icon" href="{{ url(config('app.cloud_url').'/assets/ico/favicon.png') }}">
