    ...
    <div class="container px-0 pt-40 pb-60">
        ...
        <div class="custom-tabs mb-20 mb-xl-30">
            ...
            <ul class="d-none d-md-block">
                ...
                <li><a href="{{ lurl(trans('routes.v-search', $favAttr), $favAttr) }}" class="active"  data-id="2">{{ t('Favorite jobs') }}</a></li>

                
                @if(Auth::user()->user_type_id == config('constant.model_type_id'))
                    <li><a href="{{ lurl(trans('routes.job-info')) }}" data-id="2">{{ t('Job Info') }}</a></li>
                @endif
