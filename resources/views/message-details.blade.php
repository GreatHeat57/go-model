...
@section('content')
    <div class="container px-0 py-40">
        <a href="{{ route('messages') }}"><span class="text-center mb-20">Messages /</span></a>
        <h1 class="f-h1 prata text-center mb-0">Für Sportliche Werbekampagne</h1>
        <div class="divider mx-auto"></div>
        <div class="custom-tabs mb-20 mb-xl-30">
            {{ Form::select('tabs',[1 => 'Details', 2 => 'Messages'],null) }}
            <ul class="d-none d-md-block">
                <li><a href="{{ route('message-details') }}" class="active">Details</a></li>
                <li><a href="{{ route('message-texts',['id' => 77]) }}" class="position-relative">Messages<span class="msg-num">23</span></a></li>
            </ul>
        </div>
                ...
                <div>
                    ...
                    <div class="border">
                        ...
                        <div class="row mx-0 pt-60 px-20 pb-30 position-relative">
                            <img srcset="{{ URL::to(config('app.cloud_url').'/images/icons/ico-company-sample.png') }},
                                 {{ URL::to(config('app.cloud_url').'/images/icons/ico-company-sample@2x.png') }} 2x,
                                 {{ URL::to(config('app.cloud_url').'/images/icons/ico-company-sample@3x.png') }} 3x"
                                 src="{{ URL::to(config('app.cloud_url').'/images/img-logo.png') }}" alt="{{ trans('metaTags.Go-Models') }}" class="rounded-circle posted_by-img border"/>
                            <div class="col-md-5 col-xl-3 mb-30 mb-md-0">
    ...
    @include('childs.model-bottom-bar-message-details')
@endsection