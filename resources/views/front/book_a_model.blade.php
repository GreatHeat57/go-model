...
@section('content')
    <div class="cover">
        <img src="{{ URL::to(config('app.cloud_url').'/images/covers/book_a_model.jpg') }}" alt="{{ trans('metaTags.img_Go-Models-Book-Model') }}" />
        <div class="inner">
            <div class="text">
                <div class="holder">
                    <h1>{{ trans('frontPage.go_to_success') }}</h1>
                    <h3>{!! trans('frontPage.model_search_title') !!}</h3>
                    <p>{!! trans('frontPage.model_search_desc') !!}</p>
                    <!-- <a href="#" class="watch">{{ trans('frontPage.btn_watch') }}</a> -->
                </div>
            </div>
        </div>
    </div>
