...
@section('content')
	...
	<?php $image = url('images/error_images/500.png'); ?>
    <div class="notfoundsection">
         <div class="notfoundsectionwrap">
            <div class="notfoundcontent">
               <div class="somethingwrongtext"><img src="{{ $image }}" alt="500 {{ t('internal_error_label') }}">
               	<?php /* <span>{{ t('internal_error_label') }}</span> */ ?>
               </div>
...
<?php /* 
	<div class="block mg-b-20 " style="background: #f1f6fa;">
        <h2 class="mg-b-20 warning-font">500</h2>
        <h3 class="playfair warning-font"> 500 Internal Server Error.</h3>
