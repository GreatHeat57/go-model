...
<head>
	...
	<link rel="shortcut icon" href="{{ config('app.cloud_url').'/uploads/'.config('settings.app.favicon')) . getPictureVersion() }}">
	...
	@if (config('lang.direction') == 'rtl')
		...
		<link href="{{ url(config('app.cloud_url').'/css/app.rtl.css') }}" rel="stylesheet">
	@else
		<link href="{{ url(config('app.cloud_url').'/css/app.css') }}" rel="stylesheet">
	@endif
	@include('layouts.inc.tools.style')
	<link href="{{ url(config('app.cloud_url').'/css/custom.min.css') . getPictureVersion() }}" rel="stylesheet">
...
<script src="{{ url(config('app.cloud_url').'/js/app.min.js') }}"></script>
