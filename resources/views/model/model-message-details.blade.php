...
@section('content')
    <div class="container px-0 py-40">
        <a href="{{ route('model-messages') }}"><span class="text-center mb-20">Messages /</span></a>
        ...
        <div class="custom-tabs mb-20 mb-xl-30">
            ...
            <ul class="d-none d-md-block">
                <li><a href="{{ route('model-message-details') }}" class="active">Details</a></li>
                <li><a href="{{ route('model-message-texts') }}" class="position-relative">Messages<span class="msg-num">23</span></a></li>
            </ul>
        </div>
    ...
    @include('children.model-bottom-bar-message-details')
@endsection