...
if (isset($data)) {
    ...
    $sedcard4 = array();
    $sedcard5 = array();
    $approve_icon =  URL::to(config('app.cloud_url') . '/images/icons/approve_icon.png');
    $reject_icon = URL::to(config('app.cloud_url') . '/images/icons/reject_icon.png');
    $pending_icon = URL::to(config('app.cloud_url') . '/images/icons/pending_icon.png');
    // print_r($sedcard_5);
	foreach ($sedcard_5 as $key => $sedcard) {
        if ($sedcard['image_type'] == 1 && $sedcard['id'] != 0) {
            if($sedcard['active'] == 1){
                $sedcard['status_icon'] = $approve_icon;
            }elseif ($sedcard['active'] == 2) {
                $sedcard['status_icon'] = $reject_icon;
            }else{
                $sedcard['status_icon'] = $pending_icon;
            }
            $sedcard1 = $sedcard;
            $is_image = 20; 
		}
    ...
    <div class="container px-0 pt-40 pb-60" id="profile-image-div">
        ...
        <div class="position-relative">
            ...
            <div class="text-center xl-to-right-0 xl-to-top-0">
                ...
                if ($count > 0) {   ?>
                    ...
                    <a class="btn btn-white download mini-mobile mb-20" href="{{ lurl('account/'.$user->id.'/downloadsdcard') }}">{{ t('Download Sedcard') }}</a>
                    <?php 
                }   ?>
            </div>
        </div>        
        ...
        <div class="box-shadow bg-white pt-40 pb-60 pb-xl-90 mx-xl-auto">
            <div class="w-lg-750 w-xl-970 mx-auto">
                ...
                <form name="sedcard" class="form-horizontal" role="form" method="POST" id="sedcard_form" action="{{ lurl('account/sedcard') }}" enctype="multipart/form-data">
                    ...
                    <div class="px-38 px-xl-0">
                        ...
                        <div class="pb-40 mb-40 bb-light-lavender3 ">
                            ...
                            @if($image_exist)
                                <div class='line-icon' id="status_icon_1"><img src="{{ $sedcard1['status_icon'] }}" /></div>
                                            ...
                                            <div class="d-md-inline-block">
                                                <div class="upload-btn-wrapper">
                                                    ...
                                                    <a href="#" class="btn btn-white upload_white upload-picture mb-20">{{ t('select new photo') }}
                                                        <input type="file"  class="upload_image" id="sedcardFilename1" name="sedcard[filename1]"  accept="image/x-png,image/jpeg,image/jpg"/>
                                                    </a>
                                                </div>
                        ...
                        <div class="pb-40 mb-40 bb-light-lavender3 ">
                            ...
                            @if($image_exist)
                                <div class='line-icon' id="status_icon_2"><img src="{{ $sedcard2['status_icon'] }}" /></div>
                        ...
                        <div class="pb-40 mb-40 bb-light-lavender3 ">
                            ...
                            @if($image_exist)
                                <div class='line-icon' id="status_icon_3"><img src="{{ $sedcard3['status_icon'] }}" /></div>
                        ...
                        <div class="pb-40 mb-40 bb-light-lavender3 ">
                            ...
                            @if($image_exist)
                                <div class='line-icon' id="status_icon_4"><img src="{{ $sedcard4['status_icon'] }}" /></div>
                        ...
                        <div class="pb-40 mb-40 bb-light-lavender3 ">
                            ...
                            @if($image_exist)
                                <div class='line-icon' id="status_icon_5"><img src="{{ $sedcard5['status_icon'] }}" /></div>
                ...
                <div class="px-38 px-xl-0">
                    {!! t('sedcard_explanation_of_symbols') !!}
                </div>
            </div>
        </div>
    </div>
...
<style type="text/css">
    ...
    li.approve-icon:before{
        background: url(/images/icons/approve_icon.png) 0 0/28px no-repeat;
    }
    li.reject-icon:before{
        background: url(/images/icons/reject_icon.png) 0 0/28px no-repeat;
    }
    li.pending-icon:before{
        background: url(/images/icons/pending_icon.png) 0 0/28px no-repeat;
    }
   ...
   /* .modal-dialog {
    ...
    .line-icon::before{margin-right: 2%;}
    .line-icon::after{margin-left: 2%;}
    ...
    @media (min-width:1401px) {
        .line-icon::before,
        .line-icon::after { width: 26%; }
    }
    /* Portrait and Landscape */
    @media only screen  and (min-device-width: 380px)  and (max-device-width: 568px) and (-webkit-min-device-pixel-ratio: 2) {
        .line-icon { padding-top: 0px; }
        .line-icon::before,
        .line-icon::after { width: 40%; }
    }
    /* Portrait and Landscape */
    @media only screen  and (min-device-width: 281px)  and (max-device-width: 320px) and (-webkit-min-device-pixel-ratio: 2) {
        .line-icon { padding-top: 0px; }
        .line-icon::before,
        .line-icon::after { width: 37%; }
    }
    @media (max-width: 280px) {
        .line-icon::before,
        .line-icon::after { width: 35%; }
    }
    @media only screen  and (min-device-width: 321px)  and (max-device-width: 380px) and (-webkit-min-device-pixel-ratio: 2) {
        .line-icon { padding-top: 0px; }
        .line-icon::before,
        .line-icon::after { width: 39%; }
    }
</style>
