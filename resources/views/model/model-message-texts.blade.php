...
@section('content')
    <div class="container pt-40 px-0">
        ...
        <div class="custom-tabs mb-20 mb-xl-30">
            ...
            <ul class="d-none d-md-block">
                <li><a href="{{ route('model-message-details') }}">Details</a></li>
                <li><a href="{{ route('model-message-texts') }}" class="position-relative active">Messages<span class="msg-num">23</span></a></li>
            </ul>
        </div>
    ...
    @include('children.model-bottom-bar-write-message')
@endsection