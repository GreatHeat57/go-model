...
@section('search')
	@parent
	@include('model.inc.form')
@endsection

@section('content')
	<div class="main-container">
		
		@include('model.inc.breadcrumbs')
					...
					<div class="category-list">
						<div class="tab-box clearfix">
							...
							<div class="col-lg-12 box-title no-border">
								<div class="inner">
									<h2>
										<small>{{ $count }} {{ t('Model(s) Found') }}</small>
									</h2>
								</div>
							</div>
						...
						<div class="listing-filter hidden-xs">
							...
							<div class="pull-right col-sm-2 col-xs-12 text-right text-center-xs listing-view-action">
								@if (!empty(\Illuminate\Support\Facades\Request::all()))
									...
									<a class="clear-all-button text-muted" href="{!! lurl('model-list', $attr) !!}">{{ t('Clear all') }}</a>
								@endif
							</div>
