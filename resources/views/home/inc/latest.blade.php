...
?>
@if (isset($latest) and !empty($latest) and !empty($latest->posts) and  auth()->user()->user_type_id=='3')
                ...
                <div class="content-box col-lg-12 layout-section">
                    <div class="row row-featured row-featured-category">
                        ...
                        <div class="adds-wrapper jobs-list">
        					<?php
                            $modeldata = \App\Models\UserProfile::where('user_id',Auth::user()->id)->first();
                                ...
                                <div class="col-sm-1 col-xs-2 no-padding photobox">
                                    <div class="add-image">
                                        <a href="{{ lurl($post->uri) }}">
                                            <img alt="{{ mb_ucfirst($post->company_name) }}" data-src="{{ resize(\App\Models\Post::getLogo($post->logo), 'medium') }}" class="thumbnail no-margin lazyload">
                                        </a>
                                    </div>
                                </div>
                                <!--/.photobox-->
