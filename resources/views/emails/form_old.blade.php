    ...
    <table style="font-family: 'Helvetica Neue', 'Helvetica', Helvetica, Arial, sans-serif; font-size: 100%; line-height: 1.6em; width: 100%; margin: 0; padding: 0;">
        <tr style="font-family: 'Helvetica Neue', 'Helvetica', Helvetica, Arial, sans-serif; font-size: 100%; line-height: 1.6em; margin: 0; padding: 0;">
            <td style="font-family: 'Helvetica Neue', 'Helvetica', Helvetica, Arial, sans-serif; font-size: 100%; line-height: 1.6em; margin: 0; padding: 0;">
                <p style="font-family: 'Helvetica Neue', 'Helvetica', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 1.6em; font-weight: normal; margin: 0 0 10px; padding: 0;">{{ t('Country') }} : <a href="{{ lurl('/?d=' . $msg->country_code) }}">{{ $msg->country }}</a><br>{{ t('Name') }} : {{ $msg->first_name }}<br>{{ t('Email Address') }} : {{ $msg->email }}{!! (isset($msg->phone) and $msg->phone!='') ? '<br>' . t('Phone') . ' : ' . $msg->phone : '' !!}{!! (isset($msg->company_name) and $msg->company_name!='') ? '<br>' . t('Company Name') . ' : ' . $msg->company_name : '' !!}<br><br>{!! nl2br($msg->message) !!}</p>
            </td>
        </tr>
    </table>
    </div>
